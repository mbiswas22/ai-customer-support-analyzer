...
- **Interactive Dashboard** — Visualizes ticket trends, category, sentiment, and priority distributions
...
4. Use the **Dashboard** tab to explore visual summaries
5. Use the **Data** tab to filter and browse tickets
...
- [Plotly](https://plotly.com/python/) — Interactive clustering scatter chart
